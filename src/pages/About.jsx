...
import { IoIosMore, IoMdArrowDropdown, IoMdArrowDropup } from 'react-icons/io'
                ...
                <table className='w-full'>
                    <thead>
                        <tr className='bg-[#FCFCFC] h-[60px]'>
                            ...
                            <th className='px-[5px] text-start py-[10px] text-[8px] font-[600] text-[#585757]'>
                                <div className="flex items-center gap-1">
                                    Quoted
                                    <div className="flex flex-col gap-0 cursor-pointer">
                                        <AiFillCaretUp className='text-[8px]' />
                            ...
                            <th className='px-[5px] text-start pl-9 py-[10px] text-[8px] font-[600] text-[#585757]'>
