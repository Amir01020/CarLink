...
const About = () => {
    ...
    return (
        <div className="">
            ...
            <div className="cont px-[5px] pt-[50px]">

                <table className='w-full'>
                    <thead>
                        <tr className='bg-[#FCFCFC] h-[60px]'>
                            <th className='px-[5px] py-[10px] text-start pr-[10px] flex items-center gap-5 text-[10px] font-[600] text-[#585757]'>
                                <input
                                    type="checkbox"
                            ...
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Quoted</th>
                            <th className='px-[5px] text-start pl-9 py-[10px] text-[10px] font-[600] text-[#585757]'>Notes</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Assigned to</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Shipper</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Vehicles</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Orig/Dest</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Quote</th>
                            <th className='px-[5px] text-start py-[10px] text-[10px] font-[600] text-[#585757]'>Est. Ship</th>
