            ...
            <div className="flex items-center gap-3">
                <div className="h-[25px] border-[0.6px] items-center border-solid bg-[#F9F9FB] border-[#D5D5D5] flex rounded-lg max-w-full">
                    ...
                    <div className="cursor-pointer h-full border-r-[1px] flex items-center gap-5 px-[10px] relative border-r-[#9797976b]">
                        <p onClick={list_click} className='text-[10px] text-[#7A7A7A] font-[700] bg-transparent'>
                            Date
                        </p>
                        <IoIosArrowDown onClick={list_click} className='text-[15px]' />
                        <div className={`absolute ${list_oupen ? 'scale-y-[1]  border-[0.6px]' : 'scale-y-[0]'} transition-[0.5s] bottom-0 border-solid rounded-[0px_0px_5px_5px] border-[#D5D5D5] translate-y-[100%] overflow-auto text-center w-full left-0 max-h-[200px] bg-[#F9F9FB]`}>
                ...
                <div className="h-[25px] relative w-[200px] border-[0.6px] border-solid rounded-lg bg-[#F9F9FB] border-[#D5D5D5] gap-2 flex items-center px-[8px]">
                ...
                <div onClick={name_list_click} className="border-[0.6px] cursor-pointer relative min-w-[80px] py-1 h-fit border-solid rounded-[8px] bg-[#F9F9FB] border-[#D5D5D5]">
                    <p className='flex items-center text-[10px] pl-[10px] justify-between pr-2'> Alan  <img src="/Path1.svg" className='w-3' alt="" /></p>
