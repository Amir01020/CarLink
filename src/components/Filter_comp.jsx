    ...
    return (
        <div className="cont px-[10px] pt-[25px] flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
                <div className="h-[20px] border-[0.6px] items-center border-solid bg-[#F9F9FB] border-[#D5D5D5] flex rounded-md max-w-full">
                    <div className="h-full px-[10px] border-r-[1px] border-r-[#9797976b] flex items-center">
                        <img className='w-[15px]' src="/filter.svg" alt="" />
                    </div>
                    <div className="cursor-pointer h-full border-r-[1px] flex items-center gap-2 px-[10px] relative border-r-[#9797976b]">
                        <p onClick={list_click} className='text-[6px] text-[#7A7A7A] font-[700] bg-transparent'>
                            Date
                        </p>
                        <IoIosArrowDown onClick={list_click} className='text-[10px]' />
                        <div
                    ...
                    <button className="h-full px-[10px] text-[6px] text-[#FF4F00] flex gap-1 items-center">
                        <img className='w-[10px]' src="/Path.svg" alt="" />
                        Reset Filter
                    </button>
                </div>
                <div className={`h-[20px] ${name_list_oupen ? 'rounded-[5px_5px_0px_0px] border-b-0' : 'rounded-[5px] border-[0.6px]'} relative w-[120px]  border-solid  bg-[#F9F9FB] border-[#D5D5D5] gap-1 flex items-center px-[8px]`}>
                    <img className='w-[8px]' src="/search.svg" alt="" />
                    <input type="text" placeholder='Search for something'
                        className='w-full outline-none placeholder-[#8BA3CB] text-[6px] bg-transparent' name="" id="" />
